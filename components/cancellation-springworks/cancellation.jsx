...
const Cancellation = () => (
  <Container>
    <br />
    <Heading>Cancellation Policy for Springworks Employees</Heading>
    <br />
    <ol>
      <li>
        <strong>0-7 Days before Check-In:</strong> A credit note worth full
        Booking Amount will be given which can be used for future bookings with
        Workcations
      </li>
      <li>
